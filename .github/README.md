...
[`@aws-sdk/client-codepipeline`](https://www.npmjs.com/package/@aws-sdk/client-codepipeline/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codepipeline@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0D61+9JS4QSbfvme4GimnoheCM+n0GWod9CPDGJxtDd4m+Pm8jYCulpkCdZD2S1b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codepipeline": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codepipeline@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codepipeline@3.895.0/index.min.mjs": "sha384-0D61+9JS4QSbfvme4GimnoheCM+n0GWod9CPDGJxtDd4m+Pm8jYCulpkCdZD2S1b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codepipeline/blob/refs/tags/3.895.0/LICENSE
```
